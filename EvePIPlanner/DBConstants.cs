...
namespace EvePIPlanner
{
    public class DBConstants
    {
        ...
        public static string PLANET_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, PLANET_TABLENAME);
        ...
        public static string RAW_PI_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, RAW_PI_TABLENAME);
        ...
        public static string P1_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, P1_TABLENAME);
        ...
        public static string P2_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, P2_TABLENAME);
        ...
        public static string P3_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, P3_TABLENAME);
        ...
        public static string P4_GET_ALL_PREPARED_STATEMENT_STRING = string.Format("select {0}, {1} from {2}", ID_FIELD, NAME_FIELD, P4_TABLENAME);
    }
}
